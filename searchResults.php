 ...
 <thead>
  <tr>
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td> <a href="http://localhost/bughound/BugHound/modifyReport_Dev.php?BugID='.$bug.'"> <input type="button" value="Update" /></a> </td> </tr> ';
...
echo '</tbody> </table> <br> <br>';
  echo '<a href="http://localhost/bughound/BugHound/searchReport.php">  <input type="button" value="back to Search" /> </a>  ';
mysqli_close($con);
