<html>
    ...
    <body>
        <form action="searchResults.php" name="searchRep" method="post">
            ...
            <tr> <td>   <b> Reported by</b> </td> <td> <select name="reportedBy" id="reportedBy"> <option selected="selected" value="all">All</option></select></td></tr>
            ...
            <tr> <td> </td> <td> <input type="submit" name="submitCreate" id="submitCreate"/> 
